  ...
  <body>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        The Multitec Wire Stripper/ Cutter is made up of high-grade steel alloy
        for maximum strength and durability. The handles are insulated with
        plastic<br> for comfort grip and greater torque. It is a one tool solution
        for two operations: Cutting and Stripping wires. The Stripper can be
        adjusted depending<br> on the size of the wire being cut, but typically it
        is used for cutting wires of 12-24 gauge.
      </p>
      <span
        style="
          font: 25px solid;
      ...
      >
        ...
        <li>Has black oxide finish to prevent corrosion</li>
        <li>Screw can be adjusted for cutting different-sized wires</li>
        <li>Can hold stripping die to a set size for repeated jobs</li>
        <li>Handle is insulated with PVC for comfort grips</li>
        <li>Weight: 300g</li>
        <li>Dimensions: 180 X 70 X 1 cm</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
