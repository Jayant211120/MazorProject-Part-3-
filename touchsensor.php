  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span> TTP223 1 Channel Capacitive Touch Sensor Module </span>
        <div class="stars">
          <div class="starsrow">
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        The TTP223 touch sensor module can be easily used with microcontrollers
        like Arduino to act as a touch input. It can replace the boring push
        button with touch pads and is also easy to use. The module uses the
        TTP223 IC to detect the touch on a capacitive pad.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Touch Sensor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
        >
        <li>Operating Voltage: 2V to 5.5V</li>
        <li>No. of channel: 1 < 15mA</li>
        <li>Output high: 0.8*Vcc</li>
        <li>Output low: 0.3*Vcc</li>
        <li>Response time: 220mS</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
