...
<html lang="en">
  <head>
    ...
    <title>Motors</title>
    <link rel="stylesheet" href="wirekesath.css" />
    <!-- Icons CDS -->
    <link
      rel="stylesheet"
    ...
    <section id="selections">
      <div class="options">
        ...
        <div class="buttons background-colorone">
          <img src="Images/jumperwire.jpg" alt="No Image Found" />
          <span style="font:45px solid">Rs:50</span>
          <form action="jumperwire.php"method=POST>
        ...
        <div class="buttons background-colorone">
          ...
          <span style="font:45px solid">Rs:150</span>
          <form action="arduinonanowire.php"method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
          ...
          <span style="font:45px solid">Rs:75</span>
