...
<html lang="en">
  <head>
    ...
    <title>Motors</title>
    <link rel="stylesheet" href="wheelkesath.css" />
    <!-- Icons CDS -->
    <link
      rel="stylesheet"
    ...
    <section id="selections">
      <div class="options">
        ...
        <div class="buttons background-colorone">
          ...
          <form action='wheeltwo.php'method=POST>
        ...
        <div class="buttons background-colorone">
          ...
          <form action='wheelone.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
          ...
          <form action='wheelthree.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
