...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/robotwheel4.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>REES52 85MM Large Robot Smart Car Wheel for arduin robot 38MM Width Surface - RED (Pack of 4)</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        Robot Wheel for a DC geared motor.The wheels are suitable for all
      ...
      <span
        style="
          ...
          padding: 10px 0px;
        "
        >REES52 85MM Large Robot Smart Car Wheel for arduin robot 38MM Width Surface - RED (Pack of 4) Specification</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>Robot smart car tire wheel,fits 4wd/wd</li>
        <li>outsite diameter 85mm,width 38mm</li>
        <li>Nylon Material Rim</li>
        <li>High quality rubber,soft,high friction</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
