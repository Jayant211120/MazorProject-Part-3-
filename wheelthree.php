...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/robot wheel 3.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>KitsGuru Large Robotics Wheels 65mm (Pack of 1)</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <span
        style="
          ...
          padding: 10px 0px;
        "
        >KitsGuru Large Robotics Wheel 65mm Specification</span
      >
      <ul
        style="
          font: 20px solid;
